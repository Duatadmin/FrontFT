...
const NextWeekFocus: React.FC = () => {
  const { currentWeekReflection, saveWeeklyReflection } = useDiaryStore();
  ...
  if (!currentWeekReflection) {
    return (
      <div className="bg-neutral-800/50 rounded-2xl shadow-card p-5 h-full">
  ...
  return (
    <div className="bg-neutral-800/50 rounded-2xl shadow-card p-5 h-full" data-testid="next-week-focus">
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea
              ...
              className="w-full p-3 text-sm bg-neutral-900/70 border border-border-light rounded-md focus:ring-1 focus:ring-accent-violet"
          ...
          {currentWeekReflection.next_week_focus ? (
            <>
              <div className="mb-4">
                ...
                <div className="bg-neutral-900/70 p-3 rounded-lg text-sm">
                  {currentWeekReflection.next_week_focus}
                </div>
              </div>
              ...
              <div className="mb-4">
                ...
                <div className="bg-neutral-900/70 p-3 rounded-lg text-sm flex items-center">
            ...
            <div className="flex flex-col items-center justify-center py-6 h-full">
              <div className="bg-neutral-900/70 h-12 w-12 rounded-full flex items-center justify-center mb-3">
              ...
              <button
                onClick={handleStartEditing}
                className="bg-accent-violet text-neutral-900 text-sm font-medium px-4 py-2 rounded-lg flex items-center hover:bg-accent-violet/90"
