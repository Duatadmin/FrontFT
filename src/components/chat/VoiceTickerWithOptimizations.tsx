...
interface VoiceTickerWithOptimizationsProps {
...
const VoiceTickerWithOptimizations: React.FC<VoiceTickerWithOptimizationsProps> = ({ 
  isRecordingActive, 
  recorder 
}) => {
...
export default VoiceTickerWithOptimizations;